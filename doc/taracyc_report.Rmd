...
Our ANOVA results are shown in the table below. *Note that LEVEL1 is the name of the factor for Biological Pathways.* All results have a p-value < 0.05, and thus we reject our null hypothesis.
